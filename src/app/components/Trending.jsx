...
//     >
//       <Link href={`/product_detials/${product._id || product.productId}`} className="block">
//         {/* Image Container */}
...
//           {/* Trending Badge */}
//           <div className="absolute top-3 left-3 z-10 px-2.5 py-1 bg-gradient-to-r from-[#8B6F47] to-[#A6845F] text-white text-[9px] tracking-[0.15em] uppercase font-medium shadow-lg flex items-center gap-1">
...
//     try {
//       // Fetch newest products first, limit to 12
...
// app/components/TrendingProducts.jsx
"use client";
